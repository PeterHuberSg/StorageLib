...
namespace TestContext  {
  ...
  public partial class SortedListParentN: IStorageItemGeneric<SortedListParentN> {
    ...
    readonly StorageSortedList<SortedListParentN, string, SortedListChild> sortedListChildren;
    ...
    public SortedListParentN(string text, bool isStoring = true) {
      ...
      Text = text;
      sortedListChildren = new StorageSortedList<SortedListParentN, string, SortedListChild>(this);
#if DEBUG
    ...
    internal void AddToSortedListChildren(SortedListChild sortedListChild) {
      ...
      DC.Trace?.Invoke($"Add SortedListChild {sortedListChild.GetKeyOrHash()} to " +
        $"{this.GetKeyOrHash()} SortedListParentN.SortedListChildren");
#endif
    }
