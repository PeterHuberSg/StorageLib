...
namespace TestContext  {
  ...
  public partial class NotMatchingChildrenListName_Parent: IStorageItem<NotMatchingChildrenListName_Parent> {
    ...
    /// <summary>
    /// None existing NotMatchingChildrenListName_Parent, used as a temporary place holder when reading a CSV file
    /// which was not compacted. It might create first a later deleted item linking to a 
    /// deleted parent. In this case, the parent property gets set to NoNotMatchingChildrenListName_Parent. Once the CSV
    /// file is completely read, that child will actually be deleted (released) and Verify()
    /// ensures that there are no stored children with links to NoNotMatchingChildrenListName_Parent.
    /// </summary>
