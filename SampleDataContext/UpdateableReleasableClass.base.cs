...
namespace DataModelSamples  {
  ...
  public partial class UpdateableReleasableClass: IStorageItemGeneric<UpdateableReleasableClass> {
    ...
    /// <summary>
    /// None existing UpdateableReleasableClass, used as a temporary place holder when reading a CSV file
    /// which was not compacted. It might create first a later deleted item linking to a 
    /// deleted parent. In this case, the parent property gets set to NoUpdateableReleasableClass. Once the CSV
    /// file is completely read, that child will actually be deleted (released) and Verify()
    /// ensures that there are no stored children with links to NoUpdateableReleasableClass.
    /// </summary>
