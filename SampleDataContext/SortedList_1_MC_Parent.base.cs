...
namespace DataModelSamples  {
  ...
  public partial class SortedList_1_MC_Parent: IStorageItemGeneric<SortedList_1_MC_Parent> {
    ...
    public IReadOnlyDictionary<string, SortedList_1_MC_Child> Children => children;
    readonly SortedList<string, SortedList_1_MC_Child> children;
    ...
    /// <summary>
    /// None existing SortedList_1_MC_Parent
    /// </summary>
    ...
    public SortedList_1_MC_Parent(string name, bool isStoring = true) {
      ...
      Name = name;
      children = new SortedList<string, SortedList_1_MC_Child>();
      onConstruct();
